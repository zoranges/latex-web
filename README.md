...
按全国组委会《论文格式规范》实现：承诺书 + 编号专用页 + 摘要页结构；题目三号黑体居中、一级标题四号黑体居中、二三级标题小四黑体左对齐、正文小四宋体单倍行距；四周 2.5cm 页边距、无页眉；图题下表题上（三线表）、核心公式编号、参考文献按引用次序（书籍/期刊/网络三种官方格式）、程序代码入附录。**正式提交时请把承诺书替换为当届官方原文。**
...
- `通用排版` — 常规 LaTeX 排版整理
- `数模国赛` — 严格按高教社杯全国大学生数学建模竞赛《论文格式规范》排版（三号黑体题目、四号黑体一级标题居中、小四宋体正文、图表编号与三线表、公式编号、官方参考文献格式、程序入附录等）
